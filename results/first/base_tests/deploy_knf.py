...
def main():
    ...
    for i in range(0, NUMBER_TESTS+3):
        ...
        instantiate_ns(ns_name='base_knf_ns', vnf_name_master='base_knf_vnf', nsd_name='base_knf_nsd', results_path=results_path)
        ...
        clean_environment(ns_name='base_knf_ns')
